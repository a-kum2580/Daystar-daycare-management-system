 ...
 * @description Main landing page hero section with responsive design and call-to-action
 * @contributor tendocalvin1 - Implemented responsive layout, added gradient overlay, and optimized image rendering
 * @contributor tendocalvin1 - Enhanced typography and spacing for better visual hierarchy
 */
