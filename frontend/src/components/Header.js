/**
 * @component Header
 * @description Main navigation header component with responsive design and authentication links
 * @contributor tendocalvin1 - Enhanced UI/UX, implemented responsive design, and added authentication links
 */
